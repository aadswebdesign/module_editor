//moduleEditor/editor_layout/layout_blocks/editor_tbs_bottom_block.js
import * as MFT from './../../factory/module_functions.js';
import * as LBE from "./layout_blocks_export.js"; 
class EditorTbsBottomBlock{
	#created_elem;
	#edt_tb_inserts;
	#edt_tb_1;
	#edt_tb_2;
	...
	constructor(obj_args){
		...
		this.#elem_data = MFT.createObjectsNA('edt_tb_bottom_block_obj',{});
...
export async function editorTbsBottomBlock(obj_args){
	return new EditorTbsBottomBlock(obj_args);
};