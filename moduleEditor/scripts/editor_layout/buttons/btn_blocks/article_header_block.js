//buttons/btn_blocks/article_header_block.js
import * as BEE from './../btn_elems_export.js';
export async function articleHeaderBlock(...args){
	...
	elem_data.btn.elem_title = 'ARTICLE HEADER (for use in article only)';
