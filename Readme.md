...
- [Notes:](#notes)
	...
	- [Functions, Callbacks and Objects:](#functions-callbacks-and-objects">Functions, Callbacks and Objects:</a>)
	- [About my createObjects() function:](#about-my-createobjects-function)
- [Documentation:](#documentation)
	- [Features:](#features)
	- [What is provided:](#what-is-provided)
	- [Obtaining a copy:](#obtaining-a-copy)
	- [Where to place what:](#where-to-place-what)
	- [How to:](#How to)
- [Testing:](#testing)
- [How to use:](#how-to-use)
- [Changes, Progress:](#changes-progress)
...
#### _Modules_:
I work with _js modules_ and all I explain here, is based on that!<br> 
_If you want to do it differently, how to do that is completely up to you_!
...
#### Features:
_As stated previously, it's a limited selection and aim is to add more features overtime_!  
...
- getIdHelper('id');  
- createObjects('obj',{});  
- A collection of webcomponents and this  _aside of ModuleEditor's webcomponents_. 
- ...?  
...
```
          const editor_layout_1 = await FT.createObjects('edt_objects',{
            ...
            editor_ctn:{
              ...
              edt_ctn_classes:['your-custom-parent-class','relative','display-flex'],
